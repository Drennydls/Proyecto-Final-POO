...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="profile" class="btn btn-default btn-flat">Editar mi perfil</a>
                </div>
                <div class="pull-right">
                  <a href="users/logout" class="btn btn-default btn-flat">Salir del sistema</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $title; ?>
        <small>Ajustes del usuario</small>
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Teléfono</b> <a class="pull-right"><?php echo $userData['contact']; ?></a>
                </li>
                <li class="list-group-item">
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#passwordTab" data-toggle="tab">Cambiar contraseña</a></li>
            </ul>
            <div class="tab-content">
              ...
              <div class="active tab-pane" id="settings">
                <div id="messages"></div>
                <form action="users/update" method="post" id="updateUserForm" class="form-horizontal">
                  <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label">Nombre de usuario</label>

                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="username" name="username" placeholder="Nombre de usuario" value="<?php echo $userData['username']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="fullName" name="fullName" placeholder="Nombre de usuario" value="<?php echo $userData['name']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label">Número de teléfono</label>

                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="contact" name="contact" placeholder="Número de teléfono" value="<?php echo $userData['contact']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
              ...
              <div class="tab-pane" id="passwordTab">
                ...
                <form action="users/changepassword" method="post" id="changepasswordForm" class="form-horizontal">
                  <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label">Contraseña actual</label>

                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="currentPassword" name="currentPassword" placeholder="Contraseña actual">
                    </div>
                  </div>
                  <div class="form-group">
  ...
  <footer class="main-footer">
    ...
    <strong>@ <?php echo date('Y'); ?> <a href="https://kedrytech.tk" target="_blank">Kedry Tech</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- Custom -->
<script src="assets/custom/js/setting.js"></script>
<script>
